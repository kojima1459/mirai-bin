...
### 目的
- 解錠コード再発行時に新しい封筒PDFを自動生成してダウンロードできるようにする

### 実装内容
- [x] LetterDetail.tsx: 再発行後に封筒PDF生成ボタンを追加
- [x] CreateLetter.tsxのhandleExportPDFロジックを再利用
- [x] 新しい解錠コードと共有リンクを含むPDFを生成

## 12. 使い方・FAQページの更新 ✅ 完了

### 目的
- 新機能（解錠コード再発行、共有リンク管理、スケジュール変更）の説明を追加

### 更新内容
- [x] FAQ.tsx: 解錠コード再発行の説明を追加
- [x] FAQ.tsx: 共有リンク管理の説明を追加
- [x] FAQ.tsx: 開封日時・リマインダー変更の説明を追加
- [x] HowToUse.tsx: 新機能の説明を追加（便利な機能セクション）
- [x] 注意点の更新（開封日時は変更可能、再発行は1回のみ）

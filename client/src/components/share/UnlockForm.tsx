            ...
            >
                ...
                <div className="space-y-4">
                    <Input
                        ...
                        className="text-center text-xl tracking-[0.3em] uppercase h-14 bg-white/5 border-white/10 text-white placeholder:text-white/30 focus:border-white/30 rounded-xl font-mono"
                        maxLength={12}
                        value={unlockCode}
                    ...
                    <div className="text-xs text-white/30">
                        {unlockCode.length}/12文字
                    </div>
                </div>

                {/* Submit Button */}
                <Button
                    className="w-full h-14 text-base rounded-full bg-white text-black hover:bg-white/90 font-semibold shadow-[0_0_20px_rgba(255,255,255,0.1)] disabled:opacity-50"
                    onClick={onSubmit}

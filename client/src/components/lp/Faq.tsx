...
const faqs = [
    ...
    {
        q: "解錠コードを紛失した場合は？",
        a: "解錠コードを紛失すると、手紙を永遠に開けなくなります。セキュリティの仕様上、運営側での再発行も不可能です。作成時に発行される「バックアップコード」を、必ず安全な場所に保管してください。"
    },
    {
        q: "いつから手紙を開けられますか？",
    ...
    {
        q: "共有リンクが他人に知られたら？",
        a: "共有リンク（URL）だけでは手紙は開きません。別途、解錠コード（12桁）が必要です。リンクとコードを別の手段（例：LINEと口頭、メールと紙）で伝えることで、安全性を高められます。"
    }
];

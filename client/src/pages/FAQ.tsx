...
export default function FAQ() {
  const warnings = [
    ...
    },
    {
      ...
      title: "開封日時は変更できません",
      description: "一度設定した開封日時は、技術的な理由により変更できません。設定前に十分ご確認ください。",
      severity: "warning"
    },
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: "下書きも暗号化されていますか？",
          a: "いいえ、下書きは暗号化されていません。編集の利便性のため、下書きはサーバーに平文で保存されます。「ゼロ知識」が適用されるのは、封緘（暗号化）後の手紙のみです。機密性の高い内容は、封緘後に確認することをお勧めします。"
        },
        {
          q: "Shamir分割とは何ですか？",
    ...
    },
    {
      ...
      questions: [
        {
          q: "解錠コードとは何ですか？",
          a: "解錠コードは、手紙を開封するために必要な12文字のコードです。手紙を封緘する際に生成され、このコードがないと手紙を開封できません。解錠コードは「XXXX-XXXX-XXXX」の形式で表示されます。"
        },
        {
          q: "解錠コードを紛失したらどうなりますか？",
          a: "解錠コードを紛失すると、手紙を開封できなくなります。運営者でも復元できません。バックアップシェアを保管している場合は、サーバーシェアと組み合わせて復号できる可能性がありますが、現在この機能は実装されていません。解錠コードは必ず安全な場所に保管してください。"
        },
        {
          q: "開封日時前に手紙を開封できますか？",
        ...
        {
          q: "開封日時を変更できますか？",
          a: "いいえ、一度設定した開封日時は変更できません。これは、時限開封の信頼性を保つための仕様です。手紙をキャンセルして新しく作成することは可能です。"
        },
        {
          q: "手紙は何回開封できますか？",
